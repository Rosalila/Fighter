...
void Paleta::cargarXML(char* archivo,int num_paleta)
{
            ...
            palette=palette->NextSibling("Palette"))
    {
                ...
                c_change=c_change->NextSibling("ColorChange"))
        {
            ...
            CambioColor cambio_color(Color(atoi(max_color->Attribute("alpha")),atoi(max_color->Attribute("red")),atoi(max_color->Attribute("green")),atoi(max_color->Attribute("blue"))),
                                     Color(atoi(min_color->Attribute("alpha")),atoi(min_color->Attribute("red")),atoi(min_color->Attribute("green")),atoi(min_color->Attribute("blue"))),
